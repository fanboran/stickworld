...
- 当前活跃交接文档：
  ...
  - `docs/项目/交接/游戏AI集大成-进度与交接.md`（任务：业界AI机制复刻与分层集成（CoH已逆向，RimWorld/全战等候选），设计文档 `docs/设计/系统/12-游戏AI系统.md`，批次 A1~A8，继任组织批次 3 收官后接棒；组织分支 `agent/organization-deepening` 已收官并入 main）
