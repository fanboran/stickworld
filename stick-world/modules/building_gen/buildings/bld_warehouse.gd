@tool
extends Building
## 仓库 - 程序化纹理版（复制自 bld_barracks.gd，改棕黄木色调区分储物建筑）
##
...
const C_THATCH_MAIN = Color(0.65, 0.48, 0.25)
const C_THATCH_LEFT = Color(0.58, 0.42, 0.22)
const C_WOOD_FRONT   = Color(0.38, 0.25, 0.14)
const C_WOOD_BACK    = Color(0.28, 0.18, 0.10)
const C_WOOD_BEAM    = Color(0.32, 0.22, 0.13)
const C_WOOD_STRUT   = Color(0.34, 0.24, 0.14)
