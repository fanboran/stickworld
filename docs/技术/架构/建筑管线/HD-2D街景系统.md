...
| **背景地面带**（城内，远端→0.42，**y=PLAT_H 与建筑带同高**） | 城内地面延续到地平线 | 石板/草（与台面带同材质分幅，tile/tint 逐项一致、分界同在 ±28） | 同左 | ——（墙外为城外草地带 y=0） |
...
- 地面贴图（2026-09-15 定稿）：**全部世界坐标锚定 UV**（同材质跨带无缝续接、缩放全局一致）；背景地面带与建筑带**同高**——建筑带身后的城内地面保持台面标高到地平线，无"踩空"落差（创始人 2026-09-15），与台面带同材质分幅（创始人 2026-09-16：同高即同一片地表，材质跟台面），只铺到**第二排后景根部**（地平线=第二排楼脚）；墙外野地=稀疏草土整块贯通。
...
| 2 | 远景地面带（城内） | far_z→0.42 | **与建筑带（台面）同高 y=PLAT_H**——建筑带身后的城内地面保持台面标高一直到地平线，无"踩空"落差（创始人 2026-09-15）；城心石板（±28）/ 草（±28→±墙线外 30），与台面带同材质分幅（tile/tint 与台面窄带一致，跨带无缝续接）；资源图维持旧分幅 y=0 平铺；**战场 = 全幅绿草单一材质 z 0→115，无分幅无铺装带**（创始人：整个大地一个材质） |
| 3 | 城外草地（野地） | far_z→46 | 墙外两侧 y=0：稀疏草土**整块贯通**（下边界→地平线不分段，创始人口径） |
| 4 | 兜底大地皮 | far_z→40 | 1200 格宽夯土，y=−0.05 压在所有分段之下，防任意缩放露底；**远端收在第二排后景基线**（=真实地平线，"地平线=第二排楼脚"，§4.0 新地平线）；战场远端与主地皮对齐（z=0 即地平线——多铺会越过地平线顶掉 2/3 构图） |
