...
| **背景地面带**（城内，远端→0.42，**y=PLAT_H 与建筑带同高**） | 城内地面延续到地平线 | 石板（flagstone，与台面同材质，拉通到墙线） | ——（由草底层接管） |

- **草底层**：整幅草地（grass_alb + `GRASS_WILD` 绿档，同战场野地口径）从地平线贯通铺到近缘（y=0，不分段），城内石板分段压其上；兜底大地皮同步用草（防视野越出分段露底时窜出异质色）。（创始人 2026-09-16：城外全是草地，稀疏草土退役；城内全部中心城区石板，城乡过渡材质——边缘区草地分幅/夯土带/gtx 交接贴花/土坎镶边——整体退役，暂缓再作。）
...
| 2 | 远景地面带（城内） | far_z→0.42 | **与建筑带（台面）同高 y=PLAT_H**——建筑带身后的城内地面保持台面标高一直到地平线，无"踩空"落差（创始人 2026-09-15）；石板（flagstone）**拉通到墙线**（2026-09-16：城内一个材质）；资源图维持旧分幅 y=0 平铺；**战场 = 全幅绿草单一材质 z 0→115，无分幅无铺装带**（创始人：整个大地一个材质） |
| 3 | 草底层（城外野地） | far_z→46 | 整幅草地（grass_alb+GRASS_WILD）**全宽贯通**（地平线→近缘不分段，y=0）——墙外露出即野地，城内段被石板分段覆盖（2026-09-16：城外全是草地，稀疏草土退役） |
