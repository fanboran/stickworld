...
> EventBus / ConfigManager / SaveManager / SceneManager / AudioManager / DebugApi（`modules/debug_GUI/api.gd`，改名前叫 `modules/debug/`） / **WorldState** / **TimeManager** / **BalanceConfig**。
