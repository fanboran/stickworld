...
func _ready() -> void:
	...
	var head: Node2D = skeleton.get_node_or_null("RigRoot/root/bone/minertorso1/bone2/bone3/minerhead1")
	if head == null:
		head = skeleton.get_node_or_null("RigRoot/root/bone/minertorso1/bone2/bone3")
	...
	if r2 != null and r2.has_method("play"):
		r2.play("walk")
	var walk_torso: Node2D = skeleton.get_node_or_null("RigRoot/root/bone/minertorso1")
