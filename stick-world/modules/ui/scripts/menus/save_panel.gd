...
func _on_load(slot: int) -> void:
	...
	if game_root == null:
		...
		while parent and not parent.has_method("load_game_from_slot"):
			parent = parent.get_parent()
		if parent and parent.has_method("load_game_from_slot"):
			game_root = parent
	if game_root and game_root.has_method("load_game_from_slot"):
