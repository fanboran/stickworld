...
- 当前活跃交接文档：
  ...
  - `docs/项目/交接/火柴人视觉修复-进度与交接.md`（任务：描边融合+缩放抗锯齿；**批次 1-4 已合并，批次 4b~4g 观感迭代已提交，批次 4h「标准放松站姿+缺陷狩猎」做一半——裸 rig 塌块阻塞，含实体覆写骨骼/rest 驼背等一手实锤，接手先读 4h 节**；用户已授权矢量底层重构；worktree `.temp/stickman-visual` 保留）
