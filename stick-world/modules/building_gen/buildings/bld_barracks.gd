@tool
extends Building
## 兵营 - 程序化纹理版（复制自 pg_smithy_lv1.gd，改红色调区分军事建筑）
##
...
const C_THATCH_MAIN = Color(0.72, 0.28, 0.22)
const C_THATCH_LEFT = Color(0.62, 0.24, 0.20)
const C_WOOD_FRONT   = Color(0.42, 0.18, 0.14)
const C_WOOD_BACK    = Color(0.32, 0.12, 0.10)
const C_WOOD_BEAM    = Color(0.36, 0.16, 0.12)
const C_WOOD_STRUT   = Color(0.38, 0.18, 0.13)
