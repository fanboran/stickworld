extends Node
## building_gen / stone_wall shader 基础结构测试
##
## 运行：
##   godot --headless --path stick-world res://tests/modules/building_gen/test_stone_wall_shader.tscn

const TestRunner := preload("res://tests/core/test_runner.gd")

const SCENE_PATH := "res://modules/building_gen/materials/stone_wall/scenes/stone_wall_debug.tscn"
const SHADER_PATH := "res://modules/building_gen/materials/stone_wall/shaders/stone_wall.gdshader"
...
func _register_tests() -> void:
	_runner.add_test("StoneWallDebug 场景可实例化", _test_scene_instantiate)
	_runner.add_test("Sprite2D 使用石墙 ShaderMaterial", _test_material_and_shader)
...
func _test_scene_instantiate() -> void:
	...
	_runner.assert_true(packed != null, "应能加载 stone_wall_debug.tscn")
	if packed == null:
		return
...
func _test_material_and_shader() -> void:
	...
	if mat != null:
		...
		if mat.shader != null:
			_runner.assert_equal(mat.shader.resource_path, SHADER_PATH, "shader 路径应为 stone_wall.gdshader")
...
func _test_shader_uniforms() -> void:
	...
	_runner.assert_true(shader != null, "应能加载石墙 shader")
	if shader == null:
		return
	...
	var required := [
		...
		"length_var", "height_var", "position_jitter", "row_height_var",
		"corner_radius", "corner_radius_var", "edge_wave", "edge_roughness", "oil_scale",
		"corner_cut_chance", "corner_cut_amount",
		"crack_chance", "crack_width", "crack_opacity",
		"color_light", "color_mid", "color_dark", "color_mortar",
		"color_var", "color_block_blend", "light_dir",
		"scratch_count", "scratch_width", "scratch_opacity", "stain_amount",
		"mortar_var", "mortar_shadow", "seed", "show_grid"
	]
	for u in required:
...
func _test_capture_helper() -> void:
	...
	if helper != null:
		...
		_runner.assert_equal(helper.output_path, "res://modules/building_gen/materials/stone_wall/reference/stone_wall_debug_capture.png", "默认输出路径")
