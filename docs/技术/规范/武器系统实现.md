...
```gdscript
# 装备
$StickmanRig.weapon_scene = load("res://modules/units/scenes/components/weapon_sword_placeholder.tscn")

# 换武器
$StickmanRig.weapon_scene = load("res://modules/units/scenes/components/weapon_sword_placeholder.tscn")

# 双持
$StickmanRig.offhand_scene = load("res://modules/units/scenes/components/weapon_sword_placeholder.tscn")  # 当前仅有占位剑场景
