...
## opts 为 v12 笔触参数（slant/stretch/slender/taper_min，见 ProceduralMaterials；
## 缺省与旧版行为逐像素一致，既有调用方零影响）
static func make_thatch_layered(w: int, h: int, seed_value: int = 0, opts: Dictionary = {}) -> ImageTexture:
	return ProceduralMaterials.make_thatch_layered(w, h, seed_value, opts)
