...
- 当前活跃交接文档：
  ...
  - `docs/项目/交接/游戏AI集大成-进度与交接.md`（任务：业界AI机制复刻与分层集成——CoH/RWR/SWL 三家已登记，批次 A1~A9，设计文档 `docs/设计/系统/12-游戏AI系统.md`；**A1、A9、A2 已完成**，下一批 A3/A4/A5，分支 `agent/game-ai`，worktree `.temp/game-ai`）
