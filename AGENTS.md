...
- 当前活跃交接文档：
  ...
  - `docs/项目/交接/火柴人视觉修复-进度与交接.md`（任务：描边融合+缩放抗锯齿；**批次 1-4 已合并，批次 4b~4g 观感迭代已提交，批次 4h 标准站姿场景已修通+缺陷清单 D1~D11 落档，待创始人选重构路线（建议 a 换 rest 几何）**；用户已授权矢量底层重构；worktree `.temp/stickman-visual` 保留）
