...
> **真相源**：[`docs/设计/系统/12-游戏AI系统.md`](../../设计/系统/12-游戏AI系统.md)（设计基线：分层范式 + 复刻登记表 + 批次表）；[`docs/审计/英雄连AI逆向_2026-09-11.md`](../../审计/英雄连AI逆向_2026-09-11.md)（CoH 逆向笔记，用完即删类）；[`docs/技术/架构/组织系统架构.md`](../../技术/架构/组织系统架构.md)（L3 层基建）。
...
| A8+ | Pro | 其他游戏逐个引入（候选见设计文档 §3.2） | 创始人裁决 | 设计文档 §3.2 |

**依赖图**：A1→A2→{A3,A4,A5}→A6；A7/A8 独立线；A2 起依赖组织批次 3-F2。
...
| 决策 | 结论 |
|---|---|
| 知识产权红线 | 复刻机制不复刻代码；逆向件永不入库；数值按本项目量纲重定（设计文档 §二） |
